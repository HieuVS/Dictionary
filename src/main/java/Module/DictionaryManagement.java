...
public class DictionaryManagement {
    ...
    public void updateDict(){
        ...
        while (choice.equals("y")){
            ...
            {
                if(dict.words[i].getWord_target().trim().equals(word.trim())){
                    dict.words[i].setWord_explain(mean);
                    System.out.println("Updated!");
                    break;
                }
                else if(!dict.words[i].getWord_target().trim().equals(word.trim())&i==dict.numberOfWord-1){
    ...
    public void deleteWord(){
        ...
        while (choice.equals("y")){
            ...
            word=sc.nextLine();
            for(int i=0;i<dict.numberOfWord;i++){
                if(word.trim().equals(dict.words[i].getWord_target())){
                    k=i;
                    break;
                }
                else if((!dict.words[i].getWord_target().equals(word.trim()))&i==dict.numberOfWord-1){
